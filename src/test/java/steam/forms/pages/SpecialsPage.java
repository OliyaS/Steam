...
public class SpecialsPage extends BasePage {
    ...
    public boolean checkDiscount() {
        ...
        firstPrice = Double.parseDouble(CommonFunction.regexGetMatch(prices[0]));
        finalPrice = Double.parseDouble(CommonFunction.regexGetMatch(prices[1]));
        discount = Integer.parseInt(CommonFunction.regexGetMatch(maxDiscount));
