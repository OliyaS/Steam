...
public class GamePage extends BasePage {
    ...
    public double getOriginalPrice() {
        return Double.parseDouble(CommonFunction.regexGetMatch(lblOriginalPrice.getText()));
    }

    public double getFinalPrice() {
        return Double.parseDouble(CommonFunction.regexGetMatch(lblFinalPrice.getText()));
    }

    public int getDiscount() {
        return Integer.parseInt(CommonFunction.regexGetMatch(lblDiscount.getText()));
    }
